...
|---|---|---|---|---|---|
| `agatha` <https://agatha.arch.be/> | archive | login | name-index, image-read | 45 | Belgian civil and parish registers by commune and year, with scans. The primary route to 19th-century Belgian acts. |
...
| `familysearch` <https://www.familysearch.org/> | index | login | name-index, image-read, full-text | 33 | Belgian civil and church registration, with act images. |
...
| `vrijwilligersrab` <https://www.vrijwilligersrab.be/> | index | open | name-index | 6 | Volunteer transcriptions of West-Flemish marriage and death records. |
