# Family Tree of Renée & Léon Bundervoet — Research Log
...
**Status:** 302 people. Deepest confirmed root reaches ~1440 (Gillis Sabbe); the Bundervoet surname line now reaches ~1560 (Petrus Bundervoet, Evergem).
...
## 1. The eight lines at a glance

| Line | Side | Deepest documented ancestor | Wall type |
|---|---|---|---|
| **Bundervoet** | Shaun's father | Joannes Bundervoet, d. 1760 Evergem | Pre-1796 Evergem parish registers |
...
## 2. Findings confirmed this session

**Thumas (paternal) — root pinned.**
Antoine Thumas born **11 Nov 1656 in Biez (Brabant wallon)**, died 25 Jan 1707 Grez-Doiceau; married Dieudonnée Daix in Grez-Doiceau on 30 Nov 1687 (original church act survives). No parents recorded in any tree → documented top of the line. Chain down to the present: Antoine → Jean Lambert (1701) → Georges (1) → Georges Lambert → Georges (1805) → **Georges Carolus Josephus (1836, Grez-Doiceau → married Kraainem 1872)** → J.B. Georgius (1876) → **Jean (1907–1995) ⚭ Marie Louise Crabbé** → *[François, privacy-sealed]* → Thiery (1960) → Dorien → Renée & Léon.

**Thumas (maternal) — extended a generation.**
Joanna Vandenbemden's 1902 Kraainem marriage act named her parents: **Henricus Augustinus Vandenbemden (1849 – d. 12 Aug 1889 Kraainem) & Maria Theresia Coekelberghs (1848)**. Antonia Bossin's parents confirmed as **Guilielmus Bossin (landbouwer) × Anna Catharina Peremans** (from the 1872 marriage record).

**François Thumas's mother identified.** Jean Thumas (1907–1995) married **Marie Louise Crabbé** — so she is François's mother (on the inferred Jean-is-father link). Her own parents are unrecoverable (Kraainem ~1930s marriage, privacy-sealed; Crabbé is common).

**Bostyn – Cappaert — extended up to three generations** (via the Vynce Lémans `vxnce13` tree, which is his own documented ancestry, and the `isavdw` tree, sourced to the Rijksarchief search robot):
- Henricus Bostyn (1869 Varsenare – 1947 Oostende) → parents **Henricus Josephus Bostyn (18 Dec 1841 Varsenare, innkeeper) × Mathilde Desmet (1841)**, married 1867 Sint-Andries.
- Carel Louis Cappaert (1835–1918 Oostkamp) → parents **Bernardus Cappaert × Sophia Vanhoucke**.
- Juliana Stroobandt precisely dated: **12 Sep 1839 Oedelem – 11 Feb 1921 Oostkamp**.
- Elodia Octavia Bostyn (1908–1997), Marcel's mother, confirmed as Henricus Bostyn & Judith Cappaert's daughter.

**De Keyser — the Gustaaf puzzle resolved (by family).**
Cosette confirms **Jerome Dekeyser (1897–1972) is Roland's grandfather**, so Gustaaf is Jerome & Léonie's **son** (born ~1920s Oostende, a brother of Albert 1920–1972) — *not* the 1899 Gustavus-Josephus (who is a great-uncle). Édouard Dekeyser fully documented: b. **12 Nov 1876 Hamme-Merchtem** (Vl.-Brabant, postal 1785, *not* the Oost-Vlaanderen Hamme) – d. 8 Sep 1951 Oostende; ⚭ Louise Bocklandt 4 May 1901 Hamme; children across 1897–1905. Louise Bocklandt: **1877 Hamme-Merchtem – 1946 Oostende, buried Stene** (Roland's cemetery).

---

## 3. Open frontiers — the exact record to pull next

*These are walls only because the parents named inside a specific act haven't been transcribed online. Each is "one scan away."*

| Person | Record to read | Where |
|---|---|---|
| **Henricus Josephus Bostyn** (1841) | Varsenare birth act, 18 Dec 1841 | Rijksarchief (agatha.arch.be) |
| **Mathilde Desmet** (1841) | her ~1841 birth act + 1867 Sint-Andries marriage | Rijksarchief |
| **Bernardus Cappaert & Sophia Vanhoucke** | Bernardus's birth (~1800–1810, Oostkamp?) | Rijksarchief |
| **Juliana Stroobandt** (1839) | Oedelem birth act, 12 Sep 1839 | Rijksarchief |
| **Édouard Dekeyser** (1876) & **Louise Bocklandt** (1877) | Hamme-Merchtem **1901 marriage act** (names both couples' parents), or their 1876/1877 birth acts | Rijksarchief, Hamme-Merchtem (Vl.-Brabant) registers |
| **Joannes Bundervoet** (d. 1760) | his baptism/marriage in the pre-1796 Evergem parish registers (surname runs back to a Joanna Bundervoet b. 1642, Ertvelde/Evergem) | Rijksarchief parish books |

> **Tip for the archive visit:** search.arch.be / agatha.arch.be hold the scanned civil registers by commune and year. Go straight to the commune + year + act number above. 19th-century Belgian civil acts are handwritten but formulaic — the parents are named in the opening lines ("zoon/dochter van … en …").

---

## 4. Genuinely depleted roots (no further online)

- **Antoine Thumas** — Biez, 1656. Above him needs 17th-c. Biez/Grez-Doiceau parish books.
- **Livinus Paelinck** — ~1618, Sint-Niklaas/Waasland. Deepest in the whole tree alongside Vanstechele.
- **Joannes Vanstechele** — b. before 1673, Woumen (coastal West Flanders).
- The 18th-century Walloon Thumas wives (Daix 1665, Leclercq 1710, Noel 1751, Quinart, Joostens 1810) — low-yield; parents would come from Grez-Doiceau parish registers.

---

## 5. Unresolved 20th-century questions (privacy / offline)

- **Gustaaf Dekeyser** (Roland's father, ~1920s): in England when Roland was born (1943). Whether he died in the war is **uncertain** (family unsure). Not in Belgian civil indexes (birth just inside the privacy window; life/death abroad). **Decisive records:** Roland's 1943 London birth certificate (England & Wales GRO, **Edmonton** registration district — Tottenham; mother's maiden name Vandewalle) via FreeBMD/GRO; a UK marriage 1940–43; a UK death 1943–45; or Free Belgian Forces / Brigade Piron rolls if he served.
- **Simonne Vandewalle** (Roland's mother): two documented Oostende candidates — **Simonne Florida (b. 6 Jun 1913, parents Petrus Franciscus Antonius Vandewalle 1884 × Magdalena Clementia Willaert 1888)** and Simonne Augusta (1914). Not yet linked to Gustaaf; the marriage or Roland's birth cert would confirm which and name her parents.
- **Roland's sister** (name unknown): born ~1940s (England or Oostende); her birth record is another route to confirm the parents.
- **René Janssens & Anna Van Craenenbroeck** (Chris & Eric's parents): witloof farmers from Zaventem who moved to the coast (Middelkerke); René died in Oostende, Anna in the Zaventem/Leuven area — both after 2000, but their notices aren't in the digitized Mediahuis obituary archive (coast/Brabant papers not covered). Their ancestry is behind the 100-year privacy wall. **Unlock:** a family memorial card (bidprentje) for René or Anna.

---

## 6. Sources & Geneanet trees used

**Civil & parish records** (via Geneanet + MyHeritage indexed collections): Belgian civil registration (West-Vlaanderen, Brabant); "Avis de mariage en Belgique 1792–1899"; Rijksarchief zoekrobot; Oostende Burgerzaken; cemetery indexes (Stene, Oostende).

**Geneanet member trees drawn on:**
- `stefpaelinck` (Stef Paelinck) — De Keyser & Paelinck lines, Oostende
- `natamarcelle` (Natacha Quinet) — Édouard Dekeyser (Sosa 56)
- `vxnce13` (Vynce Lémans) — Bostyn–Cappaert–Desmet ancestry
- `isavdw` — Cappaert (Rijksarchief-sourced)
- `1960dirk` (Dirk Teerlinck) — Bostyn/Cappaert with act numbers
- `marcelcroon` (Marcel Croon), `michelv990` (Michel Vandam), `jerome5530` (Jerome Debie), `jswaelens` — Thumas (Kraainem & Grez-Doiceau)
- Fauconier / Bauwens "Bundervoet–Vermeulen" parenteel — Bundervoet (Evergem/Oostende)
- `wernero` (Werner Osaer) — Devriendt/Smessaert/Ramon
- `stechec` (Christian Vanstechelman) — Vanstechele

**Obituary archives checked** (for the 20th-c. people): inmemoriam.be (Mediahuis), ingedachten.be / DELA — coverage gaps noted above.

---

## 7. Method notes (for continuing the work)
...
generation above it refused

Entirely a `vrijwilligersrab` volunteer INDEX/Detail transcription pass — no register image
was read anywhere in it, so every fact below is `sup`, never `doc`. FamilySearch was
`blocked` on both the target waypoint and the corroborating birth act (HTTP 403
unauthenticated on ark `3:1:QZ9J-PQZ` and film 001358587) — logged as a one-request retry
...
West-Flemish communes (Eernegem, Leffinge, Westkerke, Oostkerke-bij-Damme) — exactly the
surname-and-region trap CLAUDE.md rule 1 exists for. Their stated death dates (Ferdinandus
d. Oudenburg 06/07/1803 = 17 Messidor XI; Anna Theresia Termote d. Oudenburg 05/05/1804 = 15
...
**Four raw Detail pages promoted to `data/artifacts/`**, POST-only results with no
bookmarkable URL: `janssen-huyghebaert-1851-marriage-oostende`,
`janssen-declerck-1819-marriage-oostende`, `huyghebaert-derudder-1821-marriage-oudenburg`,
