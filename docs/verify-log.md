...
| 33 | 2026-07-26 | egidius_peremans | — | NOT FOUND | FamilySearch has no death record for him in any collection — the result set's own facets offer no *Overlijden* at all. Zaventem deaths are missing here as at AGATHA. **But the marriage-annex route is untried**, and there are now three more children to search it through. | — |
| 33 | 2026-07-26 | peremans | — | LEAD (not grafted) | Three probable siblings — Maria Josephina, Joannes Athanasius, Cornelius — on rows giving the parent pair exactly. **No event date or place on any row**, so nothing is anchored; and the parent-narrowed search then drifted to an unrelated Antwerp family. Rows need opening one by one. | — |
| 34 | 2026-07-26 | mjosephina_peremans | LEAD | **ANCHORED → NEW** | The first sibling for Joanna Catharina Jacoba. Married Petrús van der Varent, **Zaventem, 5 Nov 1840** (S29). Husband and his parents come with her — four people. | — |
| 34 | 2026-07-26 | — (method) | — | **NEW TECHNIQUE** | The indexed record gave **no place**. The commune came from the **volume title on the image page** — *"Zaventem. Huwelijksakten 1840"*. That is what turns a name-only match into an anchored one. Cheap, and generally applicable. | — |
| 34 | 2026-07-26 | egidius_peremans | — | ROUTE FOUND | He was dead by Nov 1840, so marrying his daughter required a death-act extract bound into **that** volume as a huwelijksbijlage. Vlaams-Brabant indexes no deaths at all; those annexes are now the best route to his 1837 act. | — |
| 34 | 2026-07-26 | Joannes Athanasius, Cornelius Peremans | — | STILL LEADS | Two sibling rows remain unopened and unanchored. Same move should settle them. | — |
...
| 37 | 2026-07-26 | Karel Joseph Bossin | — | **MERGE REFUSED** | `research.py children` proposed linking a boy born **1901** to `bossin_cornelius_1847`, born **1847** — a 54-year gap. The blocking index matched on surname and commune. Not followed. | — |
