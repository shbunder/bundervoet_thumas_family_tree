...
date: 1864-01-12
place: Grez-Doiceau
repository: FamilySearch (register images, Belgium Brabant civil registration)
collection: Grez-Doiceau, Huwelijksakten september 1866 – april 1873, image 221 of 772 (the volume binds the marriage annexes with the acts)
source: S23
...
deepzoom tiles at full resolution, which is why the page appears in bands with the blank
paper between them dropped — the handwriting is the document's, unretouched.

What it says, in full:

> D'un acte inscrit aux Registres des Décès de la Commune de **Grez-Doiceau**,
...
> Thumas** et de **Marie Catherine Quinart**, décédés.
>
> Pour extrait conforme.
>
> **Délivré sur papier libre pour cause d'indigence constatée**, au voeu de la loi.
>
> A Grez-Doiceau le **28 7bre 1868** — L'échevin officier de l'état civil *(signature and
...
therefore still open — this document simply does not speak to it.

**Why it was findable here and not at AGATHA.** This is a *huwelijksbijlage*, a marriage
annex: an extract of a dead parent's death act, drawn up so a child could marry, and bound
into the **marriage** volume. AGATHA has no Grez-Doiceau death act for 1864 — the death
series is indexed only in a trickle after 1860 — but the extract survives inside the
marriage register, which is filmed and indexed. **Death acts hide in marriage annexes.**

**And a hard detail.** The extract was issued free of charge *pour cause d'indigence
constatée* — on certified poverty. The family could not pay the fee for the paper.
