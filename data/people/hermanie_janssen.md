...
**HER OWN DEATH ACT (2026-07-27)** — Oostende, 13 November 1926, act nr. 611, RAB ID
...
identically as "Joannes Vaniseghem", so the parent PAIR, not the father's name alone, is
what carries this), the two unnamed infant deaths that are not counted among the eight,
and the narrowed negative on an unrecorded daughter.** Filtering the birth index by her
own surname independently returns the identical eight RAB IDs found from her husband's
side — no rival couple, no ninth child.
