...
FOUR MORE CHILDREN GRAFTED (research-log §64), from a sweep of the vrijwilligersrab
Huwelijken index (`rab-bs-huwelijken`): [[flavie_vi]] (m. Stene 1920), [[eduardus_vi2]]
(m. Oostende 1927), [[valentina_vi]] (m. Stene 1931) and [[maria_vi]] (m. Stene 1935) —
each act naming both parents identically to this record, alongside [[joannes_vi]] himself,
whose own 1928 marriage act turned up in the same sweep (see his record). None of the four
acts gives a birth date, so none is recorded on these children. Three in-laws named only
by the act — Desire Camille Gunst, Petrus Theodorus Carolus Joye, Joseph Louis Zwaenepoel
— are left for a later pass rather than entered as records now.

**BIRTH PLACE AND OWN CITATION SUPPLIED (2026-07-27).** His own birth row — Oostende, act
nr. 763, RAB ID 1486308, FamilySearch waypoint QZ9J-GG1 — reads Birth Date 29/11/1880
(the Birth Date column itself, not the Certificate Date, which is blank on this row),
matching this record to the day and giving `birth.place` for the first time. It is one of
eight rows this couple has in this index — see [[joannes_vi2]] for the full sibship and
the parent-pair identifier that grounds all eight, six new siblings ([[arthur_vi]],
[[augustus_vi]], [[leontius_vi]], [[gustavus_vi]], [[joannes_vi83]], [[ludovicus_vi]],
[[joannes_vi91]]) now on file.
